...
export default function Mission() {
  return (
    <section id="the-mission" className="py-12 sm:py-16 bg-asphalt-darker relative overflow-hidden">
      
      {/* Ambient background glows */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-amber-desert/10 blur-[160px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Compact Core Thesis Callout Card */}
        <div className="max-w-4xl mx-auto mb-14">
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-amber-desert/30 shadow-xl relative overflow-hidden text-center space-y-5">
            
            <div className="w-12 h-12 rounded-2xl bg-amber-desert/15 border border-amber-desert/30 flex items-center justify-center text-amber-desert mx-auto shadow-amber-glow p-2">
              <img
                src="/logo.svg"
            ...
            <blockquote className="font-display font-black text-xl sm:text-3xl text-gradient-amber leading-snug tracking-tight">
              &quot;THE ALGORITHM SAYS BE AFRAID. <br className="hidden sm:inline" />
              WE&apos;RE GOING TO FIND THE TRUTH.&quot;
            </blockquote>

            <div className="w-16 h-1 bg-gradient-to-r from-amber-desert to-sunset mx-auto rounded-full" />

            {/* Narrative Essay */}
            <div className="text-sm sm:text-base text-parchment/90 font-normal leading-relaxed space-y-4 text-left max-w-3xl mx-auto">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4 border-t border-asphalt-border/60 text-left">
              <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-asphalt-darker/60 border border-asphalt-border/60">
                <Globe className="w-4 h-4 text-amber-desert shrink-0" />
                <div>
              ...
              <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-asphalt-darker/60 border border-asphalt-border/60">
                <Heart className="w-4 h-4 text-sunset shrink-0" />
                <div>
        ...
        <div id="creators" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            {/* Creator 1: Lee */}
            <div className="bg-asphalt-card p-5 sm:p-6 rounded-3xl border border-asphalt-border hover:border-amber-desert/40 transition-all flex flex-col sm:flex-row items-center gap-5 shadow-xl">
              <img
                src="/lee.jpg"
                alt="Lee Parsons"
                className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover border-2 border-amber-desert shadow-amber-glow shrink-0"
              />
              <div className="space-y-2 text-center sm:text-left">
                <div>
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    <h4 className="font-display font-bold text-lg text-parchment">Lee Parsons</h4>
                ...
                <div className="flex items-center justify-center sm:justify-start gap-2.5 pt-0.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="p-1.5 bg-asphalt-darker rounded-lg text-parchment-muted hover:text-amber-desert border border-asphalt-border transition-colors"
                  >
            ...
            <div className="bg-asphalt-card p-5 sm:p-6 rounded-3xl border border-asphalt-border hover:border-amber-desert/40 transition-all flex flex-col sm:flex-row items-center gap-5 shadow-xl">
              <img
                src="/jake.jpg"
                alt="Jake Parsons"
                className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover border-2 border-sunset shadow-lg shrink-0"
              />
              <div className="space-y-2 text-center sm:text-left">
                <div>
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    <h4 className="font-display font-bold text-lg text-parchment">Jake Parsons</h4>
