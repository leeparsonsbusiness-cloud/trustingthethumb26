      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Brand Logo with Transparent SVG Emblem */}
            <Link
              href="/"
              className="flex items-center gap-3 group focus:outline-none"
              aria-label="Trust The Thumb Home"
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-desert to-sunset flex items-center justify-center shadow-amber-glow group-hover:scale-105 transition-transform duration-300 p-2 text-asphalt-darker">
                <img
                  src="/logo.svg"
            ...
            <div className="hidden lg:flex xl:flex items-center gap-3">
              
              {/* Tip / Support Button */}
              <button
                onClick={() => setPaymentModalOpen(true)}
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-amber-desert to-sunset text-asphalt-darker font-display font-bold text-xs shadow-amber-glow hover:scale-105 transition-transform"
              >
                <Heart className="w-3.5 h-3.5 fill-asphalt-darker" />
                <span>Tip Brothers</span>
              </button>

              {/* Live Status Pill */}
              <div className="flex items-center gap-2 bg-asphalt-card/90 border border-amber-desert/40 px-3.5 py-1.5 rounded-full shadow-amber-glow">
            ...
            <div className="flex xl:hidden items-center gap-2">
              <button
                onClick={() => setPaymentModalOpen(true)}
                className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-desert text-asphalt-darker font-bold text-[11px]"
              >
                <Heart className="w-3 h-3 fill-asphalt-darker" />
                <span>Tip</span>
              </button>
